...
if (strlen($_SESSION['user_id']) == 0) {
	...
	if (isset($_POST['update'])) {
		...
		$sql = mysqli_query($db, "update users_orders set status='$status', arrive='$arrive' where o_id='$form_id'");
			...
			<form name="updateticket" id="updatecomplaint" method="post">
				...
				<table border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td>
							<input type="date" name="arrival_time" required="required" min="<?php echo date('Y-m-d', strtotime('+1 day')); ?>" max="<?php echo date('Y-m-d', strtotime('+11 days')); ?>" />
						</td>
					</tr>
